...
const pl: Translation = {
  ...
  guestInputLabel: 'Lista gości — jedno imię na linię; etykiety po przecinku',
  guestInputPlaceholder: 'Anna Nowak, Magda, Rodzina\nBob Kowalski\nKarol, Przyjaciel',
  next: 'Dalej →',
  ...
  clearState: 'Wyczyść',
  clearConfirm: 'Czy na pewno chcesz wyczyścić wszystkie dane?',
  languageLabel: 'Język',
}
...
const en: Translation = {
  ...
  guestInputLabel: 'Guest list — one per line; labels after comma',
  guestInputPlaceholder: 'Anna Nowak, Magda, Family\nBob Kowalski\nCarol, Friend',
  next: 'Next →',
...
const it: Translation = {
  ...
  guestInputLabel: 'Lista ospiti — uno per riga; etichette dopo la virgola',
  guestInputPlaceholder: 'Anna Nowak, Magda, Famiglia\nBob Kowalski\nCarol, Amico',
  next: 'Avanti →',
